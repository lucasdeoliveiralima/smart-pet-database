...
-- Média de gasto em compras de produtos pelos clientes
SELECT
  'R$ ' + CAST(CAST(AVG(valor) AS DECIMAL(6,2)) AS VARCHAR(6)) AS 'Gasto Médio Produtos'
FROM
  NotaFiscal_Item
WHERE
...
-- Criacao de índice para a coluna cpf_cliente da tabela Atendimento
